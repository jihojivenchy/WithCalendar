...
final class AddScheduleViewController: UIViewController {
    ...
    final let addScheduleView = AddScheduleView() //View
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        addScheduleView.titleTextField.becomeFirstResponder()
    }
...
extension AddScheduleViewController : DateTimeModeSelectionDelegate {
    func changeTimeMode() {
...
//MARK: - 시작날짜 조정작업.
extension AddScheduleViewController : StartDatePickerDelegate {
...
//MARK: - 종료날짜 조정작업.
extension AddScheduleViewController : EndDatePickerDelegate {
...
extension AddScheduleViewController : SetNotificationDelegate {
...
//MARK: - 컬러선택 작업.
extension AddScheduleViewController : SetColorDelegate {
...
//MARK: - 메모작성 작업.
extension AddScheduleViewController : SetMemoDelegate {
...
extension AddScheduleViewController {
    ...
    private func handleSaveCalendarDataToFireStore() {
        let scheduleData = addScheduleDataModel.setAddScheduleData() //유저가 작성한 데이터들을 모두 취합한 유저의 스케줄 데이터.
        ...
        //데이터 저장시작.
        addScheduleDataService.saveCalendarDataToFirestore(calendarData: calendarData) { [weak self] result in
